for jjjj=1:1:ddd
    TABDEL(jjjj)=jjjj;
      ...
      if( (CC==2)|| (CC==3) || (CC==4)|| (CC==5))
           uicontrol(gcf,'style','text', 'position',[150 mm 100  15], 'string', num2str(Occurane(jjjj)), 'BackgroundColor',[0 1 0 ])
            uicontrol(gcf,'style','text', 'position',[280 mm 100 15], 'string', num2str(DurationHFO(jjjj)), 'BackgroundColor',[0 1 0 ])
            uicontrol(gcf,'style','text', 'position',[410 mm 100 15], 'string', num2str(frequencyy(jjjj)), 'BackgroundColor',[0 1 0 ])
             uicontrol(gcf,'style','text', 'position',[540 mm 100 15], 'string', num2str(powerr(jjjj)), 'BackgroundColor',[0 1 0 ])
