...
void __ogg_fdcosqi(int n, float *wsave, int *ifac){
  const float pih = 1.57079632679489661923132169163975;
  static int k;
  static float fk, dt;
...
STIN void dradf4(int ido,int l1,float *cc,float *ch,float *wa1,
	    float *wa2,float *wa3){
  const float hsqt2 = .70710678118654752440084436210485F;
...
STIN void dradb3(int ido,int l1,float *cc,float *ch,float *wa1,
			  float *wa2){
  const float taur = -.5;
  const float taui = .86602540378443864676372317075293618F;
...
void __ogg_fdcosqb(int n,float *x,float *wsave,int *ifac){
  const float tsqrt2 = 2.8284271247461900976033774484194F;
  float x1;
